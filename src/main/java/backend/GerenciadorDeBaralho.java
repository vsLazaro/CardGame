...
public class GerenciadorDeBaralho {
    ...
    public ArrayList<ACartaTropa> populaTropa()
    {
        ...
        ACartaTropa carta;
        carta = new Tanque("Lazarento", "tanque", "adefinir", 93, 10);
        tropas.add(carta);
        ...
        tropas.add(carta);
        carta = new Terrestre("Corredor", "terrestre", "adefinir", 50, 22);
        tropas.add(carta);
        carta = new Terrestre("Cavaleiro", "terrestre", "/scenes/assets/cavaleiro.jpg", 57, 25);
        tropas.add(carta);
        carta = new Terrestre("Brendida", "terrestre", "adefinir", 45, 31);
        tropas.add(carta);
        ...
        tropas.add(carta);
        carta = new Aereo("Conservo", "aereo", "adefinir", 50, 28);
        tropas.add(carta);
        carta = new AntiAereo("Mazzomago", "antiaereo", "adefinir", 35, 40);
        tropas.add(carta);
